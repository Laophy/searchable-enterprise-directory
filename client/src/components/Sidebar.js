            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap component="div">
                        Travelers <UmbrellaIcon style={{ verticalAlign: 'middle' }}/>
                    </Typography>
                </Toolbar>
            </AppBar>
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    <ListItem disablePadding sx={{ display: 'block' }}>
                        <Link to="/account/dashboard" style={linkStyle}>
                            <ListItemButton
                                sx={{
                                    minHeight: 48,
                        ...
                        <Link to="/account/overview" style={linkStyle}>
                            <ListItemButton
                                sx={{
                                    minHeight: 48,
                                    justifyContent: open ? 'initial' : 'center',
                        ...
                        <Link to="/account/job" style={linkStyle}>
                            <ListItemButton
                                sx={{
                                    minHeight: 48,
                                    justifyContent: open ? 'initial' : 'center',
                        ...
                        <Link to="/account/contact" style={linkStyle}>
                            <ListItemButton
                                sx={{
                                    minHeight: 48,
                                    justifyContent: open ? 'initial' : 'center',
                        ...
                        <Link to="/account/compensation" style={linkStyle}>
                            <ListItemButton
                                sx={{
                                    minHeight: 48,
                                    justifyContent: open ? 'initial' : 'center',
                        ...
                        <Link to="/account/pay" style={linkStyle}>
                            ...
                            >
                                ...
                                <ListItemText primary={'Pay'} sx={{ opacity: open ? 1 : 0 }} />
                            </ListItemButton>
                        </Link>
                    </ListItem>
                </List>
                <Divider />
                <List>
                    <Link to="/users/directory" style={linkStyle}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
